...
import com.joegoggin.common.SampleFactory;
import com.joegoggin.common.SampleInfos;
...
public class GdxSamplerLauncher extends JFrame {
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent windowEvent) {
                if (lwjglAWTCanvas != null) {
                    // stop will call our dispose and stop libgdx
                    lwjglAWTCanvas.stop();
                }
            }
        });
    ...
    private void launchSelectedSample() {
        ...
        if (sampleName == null || sampleName.isEmpty()) {
            System.out.println("Sample name is not empty can't launch");
            return;
        }
